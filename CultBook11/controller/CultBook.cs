...
class Program
{
    ...
    static void ExecutarRemoverLivro(Cliente? clienteLogado, Pedido? pedidoAtual)
    {
        try
        {
            ...
            _removerLivroCarrinho.Executar(pedidoAtual, isbn);
    ...
    static Pedido? ExecutarEfetuarCompra(Cliente? clienteLogado, Pedido? pedidoAtual)
    {
        try
        {
            if (pedidoAtual == null || pedidoAtual.GetQtdItens() == 0)
            ...
            if (conf != "S")
            {
                ...
                return pedidoAtual; // mantém carrinho
            }

            _efetuarCompra.Executar(clienteLogado, pedidoAtual, forma);
    ...
    static void Main(string[] args)
    {
        ...
        do
        {
            ...
            if (clienteLogado != null && clienteLogado.Logado)
                ...
                Console.WriteLine("9 - Logout (desabilitado - ninguém logado)");
            ...
            switch (opcao)
            {
                ...
                case OP_REMOVER:
                    ExecutarRemoverLivro(clienteLogado, pedidoAtual);
                    Console.ReadKey();
                    break;
                ...
                case OP_COMPRA:
                    pedidoAtual = ExecutarEfetuarCompra(clienteLogado, pedidoAtual);
                    Console.ReadKey();
                    break;
